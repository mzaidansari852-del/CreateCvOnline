    ...
    <div className="space-y-6">
      ...
      <Alert tone="warning" title="Refunds here are bookkeeping only">
        <p>
          ...
          not call Polar, no money moves, and the customer is not notified. Issue the actual
          refund in the Polar dashboard, then record it here so the two agree. Changing the
