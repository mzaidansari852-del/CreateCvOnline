...
export const metadata: Metadata = pageMetadata({
  title: DE.pricing.metaTitle,
  description: DE.pricing.metaDescription,
  path: '/de/preise',
  locale: 'de',
  keywords: ['lebenslauf erstellen kosten', 'lebenslauf vorlage kostenlos', 'bewerbung online erstellen'],
});
 ...
 * and French pages and the checkout read — so a price change lands in one place and cannot
 * leave one language quoting last year's number. Only the words are German.
 */
/*
...
export default async function GermanPricingPage() {
  ...
  return (
    <>
              ...
              >
                {featured ? (
                  <span className="absolute -top-3 left-6">
                    <Badge tone="brand">{copy.mostChosen}</Badge>
                  </span>
                ) : null}
      ...
      <Section size="sm">
        <SectionHeading align="left" title={DE.gallery.heading} description={DE.gallery.lede} />
      ...
      <Section tone="muted" size="sm">
        <CtaBanner
          ...
          secondaryLabel={DE.home.hero.secondaryCta}
        />
      </Section>
