  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul>
          <li>
            het <strong>PayPal-transactienummer</strong>, dat op de bon staat die je bij de
        ...
        <p>
          Je kunt ook de link op de bon van PayPal gebruiken.
    ...
    body: (
      <>
        <ul>
          ...
          <li>
            <strong>Verwerking door PayPal</strong> — de opdracht gaat direct na onze goedkeuring
            de deur uit.
          </li>
          <li>
            <strong>Het geld op je rekening</strong> — drie tot tien werkdagen, afhankelijk van
            je bank of kaartuitgever. Die laatste stap ligt niet bij ons en niet bij PayPal.
          </li>
        </ul>
        <p>
    ...
    body: (
      <>
        ...
        <p>
          ...
          PayPal-bon. Het gaat in aan het eind van de periode die je al hebt betaald: tot dan
    ...
    body: (
      <>
        <p>
          ...
          aanvraagt. Een terugboeking start bij PayPal een formele procedure, duurt enkele weken
