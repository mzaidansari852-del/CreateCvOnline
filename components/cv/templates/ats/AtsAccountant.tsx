...
export const meta: TemplateMeta = {
  ...
  tagline:
    "Dates flush right in their own column, certifications given real weight.",
  description:
 ...
 */
export default function AtsAccountant({
  cv,
  customization: c,
}: CVTemplateProps) {
  ...
  return (
    <div style={{ padding: c.pageMargin, fontVariantNumeric: "tabular-nums" }}>
      ...
      >
        ...
        {lines.length > 0 ? (
          <div
            style={{ marginTop: "0.38em", fontSize: "0.92em", color: metaInk }}
          >
            {lines.map((line) => (
          ...
          >
            <h2
              ...
              style={{
                ...
                color: isCertifications ? accent : c.secondaryColor,
