...
export const meta: TemplateMeta = {
  ...
  tagline:
    "One column, one rule, one ink — the most literal reading of what a parser wants.",
  description:
...
export default function AtsClassic({ cv, customization: c }: CVTemplateProps) {
  ...
  return (
    <div style={{ padding: c.pageMargin }}>
      <header
        style={{ paddingBottom: "0.62em", borderBottom: `1px solid ${ink}` }}
      >
        <h1
          style={{
            fontSize: "1.95em",
        ...
        {cv.personal.title ? (
          <p style={{ fontSize: "1.06em", marginTop: "0.12em", color: ink }}>
            {cv.personal.title}
          </p>
        ) : null}
