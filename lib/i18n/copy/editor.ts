 ...
 * Dutch.
 *
 * The place-holder content is localised along with the labels, which is less obvious than
 * it sounds and is the difference between a form that feels Dutch and one that feels
 * imported. A Dutch user filling in the phone field should see a Dutch-shaped number, and
 * the language example under `languages.namePlaceholder` is `Engels` rather than `French`,
 * because a Dutch speaker listing languages is far more likely to start there.
 *
 * `ERK` is used for the language-level scale: it is the Dutch name for the framework the
 * English copy calls CEFR, and it is what appears on Dutch qualifications.
 */
const NL: EditorCopy = {
  editor: {
    backToCvs: "Terug naar mijn cv's",
    contentTab: 'Inhoud',
    designTab: 'Ontwerp',
    sectionsTab: 'Secties',
    letterTab: 'Motivatiebrief',
    addSection: 'Sectie toevoegen',
    addItem: 'Toevoegen',
    removeItem: 'Verwijderen',
    moveUp: 'Omhoog',
    moveDown: 'Omlaag',
    sectionEnabled: 'Zichtbaar',
    sectionHidden: 'Verborgen',
    renameSection: 'Hernoemen',
    resetName: 'Naam herstellen',
    template: 'Sjabloon',
    accentColour: 'Accentkleur',
    headingFont: 'Lettertype kopjes',
    bodyFont: 'Lettertype tekst',
    fontSize: 'Tekstgrootte',
    lineHeight: 'Regelafstand',
    pageMargin: 'Paginamarge',
    sectionSpacing: 'Ruimte tussen secties',
    paperSize: 'Papierformaat',
    dateFormat: 'Datumnotatie',
    headingStyle: 'Stijl van de kopjes',
    resetDesign: 'Terug naar de standaard van het sjabloon',
    zoom: 'Zoom',
    pageOf: (page, total) => `Pagina ${page} van ${total}`,
    downloadPdf: 'Pdf downloaden',
    preparingPdf: 'Je pdf wordt voorbereid…',
    autoSaved: (when) => `Opgeslagen ${when}`,

    personalDetails: 'Persoonlijke gegevens',
    editorView: 'Editorweergave',
    sectionField: 'Sectie',
    hiddenSuffix: ' (verborgen)',
    stepOf: (step, total) => `Stap ${step} van ${total}`,
    hiddenFromCv: 'Verborgen op het cv',
    previousSection: 'Vorige',
    nextSection: 'Volgende sectie',
    reorderAndHide: 'Secties herschikken en verbergen',
    completeness: 'Volledigheid',
    downloadPdfShort: 'Pdf',

    renameCvTooltip: 'Dit cv hernoemen',
    renameCvTitle: 'Cv hernoemen',
    renameCvBody:
      'Alleen jij ziet dit — zo staat het cv in je overzicht, het is geen kop op het document.',
    cvName: 'Naam',
    undo: 'Ongedaan maken (Ctrl+Z)',
    redo: 'Opnieuw (Ctrl+Shift+Z)',
    moreActions: 'Meer acties',
    printAction: 'Afdrukken…',
    createShareLink: 'Deellink maken',
    turnOffSharing: 'Delen uitzetten',
    previewPage: 'Voorbeeldpagina',
    deleteCvAction: 'Cv verwijderen',
    deleteCvTitle: 'Dit cv verwijderen?',
    deleteCvBody: (title) =>
      `“${title}” wordt definitief verwijderd. Dit kan niet ongedaan worden gemaakt.`,
    deleteCvConfirm: 'Definitief verwijderen',
    publicNotice: 'Dit cv is openbaar:',
    copyLink: 'Kopiëren',
    linkCopied: 'Link gekopieerd',
    notSaved: 'Niet opgeslagen — opnieuw proberen',
    saveFailedHeading: 'Dit cv is niet opgeslagen',
    saveFailedKept:
      'Je werk wordt in deze browser bewaard, dus je kunt veilig doorwerken — maar sluit dit tabblad niet voordat het is opgeslagen.',
    draftFoundHeading: 'Niet-opgeslagen werk teruggehaald',
    draftFoundBody:
      'Een eerdere poging tot opslaan is mislukt en deze browser heeft een kopie bewaard. Die is nieuwer dan de versie op onze server.',
    draftRestore: 'Mijn werk terugzetten',
    draftDiscard: 'Weggooien',
    invalidFieldsHeading: 'Deze velden moeten worden aangepast voordat dit cv kan worden opgeslagen:',
    issueEntry: (sectionLabel, index) => `${sectionLabel} — item ${index}`,
    issueDateFormat: 'Gebruik een jaar (2024) of een jaar en maand (2024-06).',
    issueTooLong: 'Dit is langer dan het maximum. Maak het korter.',
    unsaved: 'Niet opgeslagen',
    offline: 'We konden de server niet bereiken. Je wijzigingen staan er nog.',

    reorderHandle: (name) =>
      `${name} verplaatsen. Druk op de spatiebalk en gebruik daarna de pijltjestoetsen.`,
    deleteNamed: (name) => `${name} verwijderen`,

    toast: {
      couldNotSave: 'Opslaan is niet gelukt',
      pdfReady: 'Pdf gedownload',
      pdfReadyBody: 'Kijk in je map met downloads.',
      pdfFailed: 'De pdf kon niet worden gemaakt',
      duplicated: 'Cv gedupliceerd',
      duplicatedBody: 'De kopie wordt geopend.',
      duplicateFailed: 'Dit cv kon niet worden gedupliceerd',
      shareOn: 'Deellink gemaakt',
      shareOnBody: 'Gekopieerd naar je klembord.',
      shareOff: 'Delen uitgezet',
      shareOffBody: 'De oude link werkt niet meer.',
      shareFailed: 'Delen kon niet worden gewijzigd',
      deleted: 'Cv verwijderd',
      deleteFailed: 'Dit cv kon niet worden verwijderd',
    },

    pro: {
      title: 'Dat is een Pro-functie',
      body: (reason) =>
        `${reason} Upgrade om elk sjabloon en alle ontwerpinstellingen te ontgrendelen.`,
      seePlans: 'Pro-abonnementen bekijken',
      share: 'Openbare deellinks zijn Pro.',
      customSections: 'Eigen secties zijn Pro.',
      lockedTemplate: (name) => `“${name}” is een Pro-sjabloon.`,
      headingColour: 'De kleur van de kopjes is een Pro-instelling.',
      bodyColour: 'De kleur van de tekst is een Pro-instelling.',
      font: 'De keuze van het lettertype is een Pro-instelling.',
      textSize: 'De tekstgrootte is een Pro-instelling.',
      lineHeight: 'De regelafstand is een Pro-instelling.',
      headingStyle: 'De stijl van de kopjes is een Pro-instelling.',
      spacing: 'De witruimte is een Pro-instelling.',
      margins: 'De marges zijn een Pro-instelling.',
      skillDisplay: 'De weergave van vaardigheden is een Pro-instelling.',
    },

    design: {
      colourGroup: 'Kleur',
      typographyGroup: 'Typografie',
      spacingGroup: 'Witruimte en pagina',
      contentGroup: 'Weergave van de inhoud',
      headingColour: 'Kleur van de kopjes',
      bodyColour: 'Tekstkleur',
      caseUpper: 'HOOFDLETTERS',
      caseTitle: 'Beginhoofdletters',
      caseAsTyped: 'Zoals getypt',
      paperHint:
        'A4 voor Nederland, België en vrijwel de hele wereld. Letter voor de VS en Canada.',
      showPhoto: 'Pasfoto tonen',
      showPhotoHint: 'Heeft alleen effect op sjablonen die een foto ondersteunen.',
      photoShape: 'Vorm van de foto',
      photoCircle: 'Rond',
      photoRounded: 'Afgerond',
      photoSquare: 'Vierkant',
      showIcons: 'Contactpictogrammen tonen',
      showIconsHint: 'Zet dit uit voor de strengste ATS-compatibiliteit.',
      skillDisplay: 'Weergave van vaardigheden',
      skillBars: 'Balken',
      skillDots: 'Stippen',
      skillTags: 'Labels',
      skillText: 'Tekst',
      skillHint:
        'Platte tekst wordt het betrouwbaarst uitgelezen. Balken en stippen zijn een visuele claim die een recruiter niet kan controleren — gebruik ze spaarzaam.',
      searchTemplates: 'Sjablonen zoeken',
      shown: (n) => `${n} getoond`,
      noMatch: (query) => `Geen sjabloon komt overeen met “${query}”.`,
      columns: (n) => (n === 1 ? '1 kol' : '2 kol'),
      ats: (score) => `ATS ${score}/5`,
      categories: {
        all: 'Alle',
        modern: 'Modern',
    ...
    preview: {
      pages: (n) => (n === 1 ? "1 pagina" : `${n} pagina's`),
      pageMarker: (page) => `Pagina ${page}`,
      zoomIn: 'Inzoomen',
      zoomOut: 'Uitzoomen',
      fitToWidth: 'Passend maken op breedte',
    },

    list: {
      maxEntries: (max) => `Dat is het maximum van ${max} items voor deze sectie.`,
      deleteBody: (name) =>
        `“${name}” wordt van je cv verwijderd. Je kunt dit ongedaan maken met Ctrl+Z.`,
      itemNumber: (label, index) => `${label} ${index}`,
      removeItemNumber: (label, index) => `${label} ${index} verwijderen`,
    },

    sections: {
      addCustom: 'Eigen sectie toevoegen',
      customHint: 'Eigen sectie',
      defaultCustomTitle: 'Eigen sectie',
      renameTitle: 'Sectie hernoemen',
      renameBody: 'Dit is het kopje dat op je cv wordt afgedrukt.',
      heading: 'Kopje',
      newTitle: 'Nieuwe eigen sectie',
      newBody:
        'Voor alles wat de twaalf ingebouwde secties niet dekken — octrooien, lidmaatschappen, lezingen, militaire dienst.',
      newPlaceholder: 'Lezingen op congressen',
      sectionHeading: 'Kopje van de sectie',
      addConfirm: 'Sectie toevoegen',
      deleteTitle: 'Deze sectie verwijderen?',
      deleteBody: (label) =>
        `“${label}” en alles wat erin staat wordt verwijderd. Je kunt dit ongedaan maken met Ctrl+Z.`,
      deleteConfirm: 'Sectie verwijderen',
      moveUp: (label) => `${label} omhoog verplaatsen`,
      moveDown: (label) => `${label} omlaag verplaatsen`,
      hide: (label) => `${label} verbergen`,
      show: (label) => `${label} tonen`,
      hideTitle: 'Verbergen op het cv',
      showTitle: 'Tonen op het cv',
    },

    sectionHints: {
      summary: 'Drie of vier regels over wie je bent en wat je oplevert.',
      competencies:
        'Drie tot zes vakgebieden, elk met de resultaten die het onderbouwen. Dit maakt een functioneel cv functioneel — begin ermee en je werkgeschiedenis mag kort blijven.',
      experience: 'Functies, werkgevers, data en de resultaten die je hebt behaald.',
      education: 'Diploma’s, opleidingsinstellingen en relevante vakken.',
      skills: 'Harde en zachte vaardigheden, eventueel gegroepeerd per categorie.',
      languages: 'De talen die je spreekt en je niveau per taal.',
      projects: 'Eigen projecten, open source of opdrachten voor klanten.',
      certifications: 'Vakcertificaten, licenties en diploma’s.',
      awards: 'Erkenning, prijzen en onderscheidingen.',
      volunteer: 'Onbetaald werk dat initiatief en waarden laat zien.',
      publications: 'Papers, artikelen, boeken en lezingen.',
      interests: 'Een korte, menselijke regel aan het eind van het document.',
      references: 'Referenten, of één regel “op aanvraag beschikbaar”.',
    },

    photo: {
      title: 'Pasfoto',
      body: 'Gebruikelijk in een groot deel van continentaal Europa, Noord-Afrika en het Midden-Oosten; in Nederland wisselend en in het VK, Ierland en de VS meestal weggelaten. Sjablonen zonder fotovak negeren hem gewoon.',
      upload: 'Foto uploaden',
      replace: 'Foto vervangen',
      dropHint: 'of sleep hier een afbeelding naartoe',
      formats:
        'JPEG, PNG, WebP of AVIF, tot 8 MB. De foto wordt in je browser vierkant bijgesneden en verkleind naar 600px voordat hij wordt geüpload, zodat een grote telefoonfoto je pdf niet vertraagt.',
      signInFirst: 'Log in om een foto te uploaden.',
      unavailable:
        'Een foto uploaden kan niet omdat opslag op deze omgeving niet is geconfigureerd. Je kunt hieronder wel een link plakken.',
      failed: 'De upload is niet afgerond. Controleer je verbinding en probeer het opnieuw.',
    },
    ...
    forms: {
      personal: {
        ...
        lastName: 'Achternaam',
        title: 'Functietitel',
        titlePlaceholder: 'Senior productontwerper',
        titleHint: 'De functie waarop je solliciteert, niet per se je huidige functietitel.',
        email: 'E-mail',
        ...
        locationHint:
          'Plaats en land is genoeg. Een volledig adres is overbodig en kun je beter weglaten.',
        website: 'Website',
        websitePlaceholder: 'jouwsite.nl',
        linkedin: 'LinkedIn',
        linkedinPlaceholder: 'linkedin.com/in/jij',
        github: 'GitHub',
        githubPlaceholder: 'github.com/jij',
        photoUrl: '…of plak een link naar een foto',
        photoUrlHint:
          'Alleen nodig als de afbeelding al ergens openbaar staat. Hierboven uploaden is makkelijker en levert een kleinere pdf op.',
        linkFallback: 'Link',
        linkLabel: 'Label',
        linkLabelPlaceholder: 'Portfolio',
        linkUrl: 'URL',
        linkUrlPlaceholder: 'jouwportfolio.nl',
        links: {
          add: 'Nog een link toevoegen',
          emptyTitle: 'Geen extra links',
          emptyBody:
            'Voeg een portfolio, Dribbble, Behance, ORCID of iets anders toe dat op de pagina thuishoort.',
          deleteTitle: 'Deze link verwijderen?',
      ...
      summary: {
        label: 'Profieltekst',
        placeholder:
          'Drie of vier zinnen: wie je bent, wat je oplevert en één resultaat dat dat bewijst.',
        hint: 'Mik op 50–90 woorden. Begin met je vakgebied en je jaren ervaring, en dan het ene resultaat dat je als eerste gelezen wilt hebben.',
        wordCount: (n) => (n === 1 ? '1 woord' : `${n} woorden`),
        tooShort: ' — nog wat kort; voeg een concreet resultaat toe.',
        tooLong: ' — zo lang dat een recruiter eroverheen leest. Probeer in te korten.',
      },
      competencies: {
        list: {
          add: 'Competentie toevoegen',
          emptyTitle: 'Nog geen competenties',
          emptyBody:
            'Drie tot zes vakgebieden, elk met de resultaten die het onderbouwen. Hiermee begint een functioneel of hybride cv — en daardoor mag de werkgeschiedenis eronder kort blijven.',
          deleteTitle: 'Deze competentie verwijderen?',
          untitled: 'Naamloze competentie',
        },
        evidenceCount: (n) => (n === 1 ? '1 onderbouwing' : `${n} onderbouwingen`),
        name: 'Vakgebied',
        namePlaceholder: 'Programmamanagement',
        framing: 'Toelichting',
        framingPlaceholder:
          'Een of twee regels over wat je ermee bedoelt. Optioneel — vaak spreekt de onderbouwing voor zich.',
        evidence: 'Onderbouwing',
        evidencePlaceholder:
          'Een curriculumwijziging voor 340 leerlingen gecoördineerd over vier afdelingen, binnen een vaste examendeadline.',
        addEvidence: 'Onderbouwing toevoegen',
      },
      experience: {
        list: {
          add: 'Functie toevoegen',
          emptyTitle: 'Nog geen werkervaring',
          emptyBody:
            'Begin met je meest recente functie. Stages, freelancewerk en serieus vrijwilligerswerk tellen allemaal mee.',
          deleteTitle: 'Deze functie verwijderen?',
          untitled: 'Naamloze functie',
        },
        role: 'Functietitel',
        rolePlaceholder: 'Senior productontwerper',
        company: 'Werkgever',
        companyPlaceholder: 'Atlas Cloud',
        location: 'Plaats',
        ...
        endDate: 'Einddatum',
        presentHint: 'Wordt getoond als “heden”.',
        current: 'Ik werk hier nu',
        description: 'Wat de functie inhield',
        descriptionPlaceholder:
          'Een of twee regels context: de reikwijdte van de functie, de teamgrootte, voor wie je werkte.',
        descriptionHint: 'Context, geen resultaten — die komen hieronder.',
        achievements: 'Resultaten',
        achievementPlaceholder:
          'De onboarding opnieuw opgebouwd en de activatie in twee kwartalen van 34% naar 58% gebracht.',
        addAchievement: 'Resultaat toevoegen',
        tags: 'Labels',
        tagsHint:
          'Optionele trefwoorden die sommige sjablonen als kleine chips tonen. ATS-sjablonen verbergen ze.',
        tagsPlaceholder: 'Designsystemen, Onboarding, B2B-SaaS',
      },
      education: {
        list: {
          add: 'Opleiding toevoegen',
          emptyTitle: 'Nog geen opleiding',
          emptyBody:
            'Zet je hoogste opleiding bovenaan. Aan het begin van een loopbaan hoort deze sectie bovenin het cv.',
          deleteTitle: 'Deze opleiding verwijderen?',
          untitled: 'Naamloze opleiding',
        },
        degree: 'Diploma',
        degreePlaceholder: 'Bachelor',
        field: 'Studierichting',
        fieldPlaceholder: 'Informatica',
        institution: 'Opleidingsinstelling',
        institutionPlaceholder: 'Universiteit van Amsterdam',
        location: 'Plaats',
        locationPlaceholder: 'Amsterdam, Nederland',
        startDate: 'Begindatum',
        endDate: 'Einddatum',
        grade: 'Cijfer',
        gradePlaceholder: 'Cum laude / gemiddeld een 8',
        current: 'Ik studeer hier nog',
        notes: 'Toelichting',
        notesPlaceholder: 'Titel van je scriptie, relevante vakken of een prijs.',
        notesHint:
          'De moeite waard voor wie net is afgestudeerd; later kun je dit gerust leeg laten.',
      },
      skills: {
        list: {
          add: 'Vaardigheid toevoegen',
          emptyTitle: 'Geen vaardigheden opgegeven',
          emptyBody:
            'Vijf tot vijftien is het bruikbare bereik. Groepeer ze per categorie, dan zetten de sjablonen ze netjes voor je neer.',
          deleteTitle: 'Deze vaardigheid verwijderen?',
          untitled: 'Naamloze vaardigheid',
        },
        name: 'Vaardigheid',
        namePlaceholder: 'Figma',
        category: 'Categorie',
        categoryPlaceholder: 'Tools',
        categoryHint: 'Optionele groepering.',
        level: 'Niveau',
      },
      languages: {
        list: {
          add: 'Taal toevoegen',
          emptyTitle: 'Geen talen opgegeven',
          emptyBody:
            'De moeite waard bij elke internationale sollicitatie, en verwacht op een Europees cv.',
          deleteTitle: 'Deze taal verwijderen?',
          untitled: 'Naamloze taal',
        },
        name: 'Taal',
        namePlaceholder: 'Engels',
        level: 'Niveau',
        levelHint: 'Wordt omgezet naar de ERK-schaal door sjablonen die een niveau tonen.',
      },
      projects: {
        list: {
          ...
          emptyBody:
            'Eigen projecten, open source en noemenswaardige opdrachten voor klanten. Vooral waardevol als je functietitels niet laten zien wat je kunt.',
          deleteTitle: 'Dit project verwijderen?',
          untitled: 'Naamloos project',
        },
        name: 'Naam van het project',
        namePlaceholder: 'Souk Kit',
        role: 'Jouw rol',
        rolePlaceholder: 'Maker',
        start: 'Begin',
        end: 'Eind',
        link: 'Link',
        linkPlaceholder: 'github.com/jij/project',
        description: 'Omschrijving',
        descriptionPlaceholder: 'Wat het is, voor wie het is en wat jij hebt gebouwd.',
        highlights: 'Hoogtepunten',
        highlightPlaceholder: '4.100 sterren op GitHub en meer dan 60 bijdragers.',
        addHighlight: 'Hoogtepunt toevoegen',
        tags: 'Labels',
      },
      certifications: {
        list: {
          add: 'Certificaat toevoegen',
          emptyTitle: 'Geen certificaten',
          emptyBody:
            'Licenties, vakcertificaten en diploma’s die een recruiter kan controleren.',
          deleteTitle: 'Dit certificaat verwijderen?',
          untitled: 'Naamloos certificaat',
        },
        name: 'Naam',
        namePlaceholder: 'AWS Certified Solutions Architect – Associate',
        ...
        issued: 'Uitgegeven',
        expires: 'Verloopt',
        credentialId: 'Certificaatnummer',
        verification: 'Verificatielink',
      },
      awards: {
        list: {
          add: 'Onderscheiding toevoegen',
          emptyTitle: 'Geen onderscheidingen',
          emptyBody: 'Erkenning, prijzen en onderscheidingen — interne prijzen tellen ook mee.',
          deleteTitle: 'Deze onderscheiding verwijderen?',
          untitled: 'Naamloze onderscheiding',
        },
        title: 'Titel',
        issuer: 'Toegekend door',
        date: 'Datum',
        description: 'Omschrijving',
      },
      volunteer: {
        list: {
          add: 'Vrijwilligerswerk toevoegen',
          emptyTitle: 'Geen vrijwilligerswerk',
          emptyBody:
            'Onbetaald werk dat initiatief, waarden of vaardigheden laat zien die je betaalde functies niet tonen.',
          deleteTitle: 'Dit item verwijderen?',
          untitled: 'Naamloos item',
        },
        role: 'Rol',
        ...
        current: 'Ik doe dit nog steeds',
        description: 'Omschrijving',
      },
      publications: {
        list: {
          add: 'Publicatie toevoegen',
          emptyTitle: 'Geen publicaties',
          emptyBody:
            'Papers, artikelen, boeken en lezingen. Onmisbaar op een academisch cv.',
          deleteTitle: 'Deze publicatie verwijderen?',
          untitled: 'Naamloze publicatie',
        },
        title: 'Titel',
        publisher: 'Uitgever',
        date: 'Datum',
        link: 'Link',
        authors: 'Auteurs',
        authorsPlaceholder: 'De Vries, A., Jansen, Y.',
        abstract: 'Samenvatting',
      },
      interests: {
        list: {
          add: 'Interesse toevoegen',
          emptyTitle: 'Geen interesses',
          emptyBody:
            'Een korte, specifieke regel maakt een cv menselijk. “Hardlopen op de lange afstand” zegt meer dan “sport”.',
          deleteTitle: 'Deze interesse verwijderen?',
          untitled: 'Naamloze interesse',
        },
        name: 'Interesse',
        detail: 'Toelichting',
        detailHint: 'Optioneel. Slechts sommige sjablonen tonen dit.',
      },
      references: {
        list: {
          add: 'Referent toevoegen',
          emptyTitle: 'Geen referenties opgegeven',
          emptyBody:
            'De meeste werkgevers vragen hier later om. Noem alleen iemand die daarmee heeft ingestemd — en zet hun gegevens nooit op een gedeelde link.',
          deleteTitle: 'Deze referent verwijderen?',
          untitled: 'Naamloze referent',
        },
        name: 'Naam',
        relationship: 'Relatie',
        relationshipPlaceholder: 'Direct leidinggevende',
        role: 'Functie',
        company: 'Organisatie',
        email: 'E-mail',
        phone: 'Telefoon',
      ...
      custom: {
        list: {
          add: 'Item toevoegen',
          emptyTitle: 'Nog niets in deze sectie',
          emptyBody:
            'Elk item heeft een kop, een subkop, een datum en een omschrijving — genoeg voor vrijwel alles wat een standaardsectie niet dekt.',
          deleteTitle: 'Dit item verwijderen?',
          untitled: 'Naamloos item',
        },
        heading: 'Kopje van de sectie',
        entryHeading: 'Kop',
        entrySubheading: 'Subkop',
        entryDate: 'Datum',
        entryDatePlaceholder: '2024',
        description: 'Omschrijving',
      },
      letter: {
        enable: 'Motivatiebrief meesturen',
        enableHint:
          'Wordt geëxporteerd als de eerste pagina van dezelfde pdf, in de stijl van dit cv. Uitzetten bewaart het concept.',
        recipient: 'Geadresseerde',
        recipientPlaceholder: 'Mevrouw Okafor',
        recipientHint: 'Laat leeg voor “Geachte heer/mevrouw”.',
        recipientRole: 'Diens functie',
        recipientRolePlaceholder: 'Hoofd Recruitment',
        company: 'Organisatie',
        companyPlaceholder: 'Atlas Cloud',
        vacancy: 'Vacature',
        vacancyPlaceholder: 'Senior productontwerper',
        reference: 'Referentie',
        referencePlaceholder: 'REQ-2841',
        date: 'Datum',
        datePlaceholder: '2026-08-15',
        dateHint: 'Laat leeg om de datum van je export te gebruiken.',
        address: 'Adres van de organisatie',
        addressPlaceholder: 'Herengracht 18\n1015 BJ Amsterdam',
        body: 'Brief',
        bodyPlaceholder:
          'Drie of vier korte alinea’s: waarom deze functie, wat je meebrengt, en één voorbeeld dat niet op je cv staat.',
        bodyHint: 'Een lege regel begint een nieuwe alinea.',
        signOff: 'Afsluiting',
        signOffPlaceholder: 'Met vriendelijke groet,',
        signOffHint:
          'Laat je dit leeg, dan volgt de brief de conventie: “Met vriendelijke groet” bij een naam, “Hoogachtend” zonder.',
        signature: 'Ondertekening',
        signaturePlaceholder: 'Je naam',
      },
    },
  },
};

export const EDITOR_COPY: Record<Locale, EditorCopy> = { en: EN, fr: FR, de: DE, nl: NL };
